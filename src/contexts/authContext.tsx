...
export const useAuth = () =>{
 ...
 const AuthContextProvider = ({children}: {children: ReactNode}) =>{
    ...
    const navigate = useNavigate()
     ...
     const refreshToken = async() =>{
        ...
        try {
            ...
            let res = await axios.post(`${API_ACCOUNT}api/token/refresh/`, {
  ...
  const forgotPasswordConfirm = async(formData: object) =>{
    try {
        let res = await axios.post(`${API_ACCOUNT}forgot_password_confirm/`,formData)
  ...
  const changePassword = async(formdata: object) =>{
    try {
        ...
        let res = await axios.post(`${API_ACCOUNT}change_password/`,formdata, config)
        console.log(res);
